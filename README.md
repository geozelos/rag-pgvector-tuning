...
> Measured chart (also in [`docs/assets/latency-recall-chart.txt`](docs/assets/latency-recall-chart.txt)). Reproduce: `make up && make demo`. Hardware-specific — re-run before sharing.
